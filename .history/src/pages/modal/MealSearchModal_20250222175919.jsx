...
import styles from './styles/MealSearchModal.module.scss';
import { API_BASE_URL } from '@/config';

const MealCard = ({ policy }) => {
...
const MealSearchModal = ({ isOpen, onClose }) => {
    ...
    <div className={styles.modalOverlay}>
      <div className={styles.modalContent}>
        ...
        <form onSubmit={handleSearch} className={styles.searchForm}>
          ...
          {errors.searchQuery && 
            <p className={styles.errorText}>지역을 입력해주세요.</p>
          }
